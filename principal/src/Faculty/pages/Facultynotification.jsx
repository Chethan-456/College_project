...
const notifications = [
  { id: 1, title: "Faculty Meeting Tomorrow", message: "Department meeting at 10:00 AM in Conference Hall", time: "2 hours ago", urgent: true },
  { id: 2, title: "Assignment Submission Reminder", message: "Students assignment due tomorrow", time: "4 hours ago", urgent: false },
  { id: 3, title: "Lab Equipment Maintenance", message: "Lab-1 will be closed for maintenance on Friday", time: "1 day ago", urgent: false },
  { id: 4, title: "New Course Curriculum", message: "Updated syllabus available", time: "2 days ago", urgent: false },
];
...
export default function FacultyNotifications() {
  ...
  const topbarItems = [
    ...
    { label: "Notifications", path: "/notifications/faculty", dot: true, active: true },
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-7">
          <div className="bg-white rounded-2xl p-7">
            <div className="text-base font-semibold text-gray-900 mb-5">Notifications</div>
            <div className="flex flex-col gap-3">
              {notifications.map((n) => (
                <div key={n.id} className="border border-gray-200 rounded-xl px-5 py-4 flex flex-col gap-1.5 hover:bg-violet-50 hover:border-violet-200 transition-colors">
                  <div className="flex items-center gap-2.5">
                    <span className="text-sm font-semibold text-gray-900">{n.title}</span>
                    {n.urgent && <span className="bg-red-500 text-white text-xs font-semibold px-2.5 py-0.5 rounded-full">Urgent</span>}
                  </div>
